...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'extension/post')) {
				$blog[] = array(
					'name'	   => 'Статті',
					'href'     => $this->url->link('extension/post', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}

			if ($this->user->hasPermission('access', 'extension/category')) {
				$blog[] = array(
					'name'	   => 'Категорії блогу',
					'href'     => $this->url->link('extension/category', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}

			if ($this->user->hasPermission('access', 'extension/blog_setting')) {
				$blog[] = array(
					'name'	   => 'Налаштування блогу',
					'href'     => $this->url->link('extension/blog_setting', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'extension/module/custom_scripts')) {
				$marketplace[] = array(
					'name'	   => $this->language->get('text_custom_scripts'),
