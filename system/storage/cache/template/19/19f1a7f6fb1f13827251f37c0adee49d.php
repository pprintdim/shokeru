...
class __TwigTemplate_0afcfebbcbe28948745e70cdfdf5b18e extends Template
{
...
document.addEventListener(\"DOMContentLoaded\", function () {
    ...
    function submitFilters() {
        ...
        // Додаємо фільтри
        filterForm.querySelectorAll('input[name=\"filter[]\"]:checked').forEach(input => {
        ...
        if (priceFrom && priceFrom.value) params.set('price-from', priceFrom.value);
        if (priceTo && priceTo.value) params.set('price-to', priceTo.value);
        ...
        const url = baseUrl + 'index.php?route=product/search&' + params.toString();
