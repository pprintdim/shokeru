...
$_['heading_form'] = 'Будь ласка, заповніть форму для запиту на повернення товару';
// Text
...
$_['text_reason'] = 'Інформація про товар та причину повернення';
...
$_['text_product_unpacked'] = 'Товар розпакований';


// Select reason

$_['text_reason_0'] = 'спорчений по прибуттю';
$_['text_reason_1'] = 'Несправність';
$_['text_reason_2'] = 'Помилка замовлення';
$_['text_reason_3'] = 'Отримано неправильний товар';
$_['text_reason_4'] = 'Інше';
...
$_['column_comment'] = 'Додаткова інформація';
...
$_['entry_comment'] = 'Коментар по поверненню';
