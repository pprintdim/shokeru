...
(function () {
    function countUp(el) {
        ...
        // число з можливими внутрішніми пробілами (напр. "15 000"), але БЕЗ хвостових —
        // інакше [\d\s]* з'їдає перенос рядка/пробіли після числа і ламає верстку
    ...
    function initCounters() {
        ...
        blocks.forEach(function (block) {
            var spans = block.querySelectorAll('.about__item > span, .aboutus__item > span, .aboutHero__stat dt > span');
