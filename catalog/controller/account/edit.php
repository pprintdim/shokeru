...
class ControllerAccountEdit extends Controller {
	...
	public function index() {
		...
		// Перевірка пароля (якщо користувач вводить новий)
		...
		$pq = $this->db->query("SELECT password_enc FROM `" . DB_PREFIX . "customer` WHERE customer_id = '" . (int)$this->customer->getId() . "'");
		$data['current_password'] = $pq->num_rows ? PassVault::dec($pq->row['password_enc'], (string)$this->config->get('config_encryption')) : '';
	...
	protected function validate() {
		// Оновлюємо пароль лише якщо поле не пусте
		if (!empty($this->request->post['password'])) {
