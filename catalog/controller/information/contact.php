...
class ControllerInformationContact extends Controller {
	...
	private function getLangPlainText($value, $language_id) {
		if (is_array($value) && isset($value[$language_id])) {
			$value = $value[$language_id];
		}
	...
	public function index() {
		...
		$data['geocode'] = $this->getLangPlainText($this->config->get('config_geocode'), $language_id);
		$data['geocode_hl'] = $this->config->get('config_language');
		$data['map_latitude'] = $this->normalizeCoordinate($this->config->get('config_map_latitude'));
		$data['map_longitude'] = $this->normalizeCoordinate($this->config->get('config_map_longitude'));
		$data['map_query'] = '';

		if ($data['map_latitude'] !== '' && $data['map_longitude'] !== '') {
			$data['map_query'] = $data['map_latitude'] . ',' . $data['map_longitude'];
		} else {
			$data['map_query'] = $data['geocode'];
		}
