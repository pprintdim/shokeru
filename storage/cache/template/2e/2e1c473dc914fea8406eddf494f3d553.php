...
class __TwigTemplate_c5bc11f30832e22b09a036d826a6fa27 extends Template
{
  ...
  <div class=\"page-header\">
    <div class=\"container-fluid\">
      <div class=\"pull-right\"><a href=\"";
        ...
        yield "') ? \$('#form-layout').submit() : false;\"><i class=\"fa fa-trash-o\"></i></button>
      </div>
      <h1>";
        // line 8
  ...
  <div class=\"container-fluid\">
    ...
    ";
      ...
      <div class=\"panel-body\">
        ...
        yield "\" method=\"post\" enctype=\"multipart/form-data\" id=\"form-layout\">
        ...
        yield "</td>
              ...
              <tbody>
                ";
        // line 47
        if ((($tmp = ($context["layouts"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 48
            yield "                ";
            $context['_parent'] = $context;
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["layout"]) {
                ...
                // line 50
                if (CoreExtension::inFilter(CoreExtension::getAttribute($this->env, $this->source, $context["layout"], "layout_id", [], "any", false, false, false, 50), ($context["selected"] ?? null))) {
                    // line 51
                    yield "                    <input type=\"checkbox\" name=\"selected[]\" value=\"";
                    yield CoreExtension::getAttribute($this->env, $this->source, $context["layout"], "layout_id", [], "any", false, false, false, 51);
                    yield "\" checked=\"checked\" />
                    ";
                } else {
                    // line 53
                    yield "                    <input type=\"checkbox\" name=\"selected[]\" value=\"";
                    yield CoreExtension::getAttribute($this->env, $this->source, $context["layout"], "layout_id", [], "any", false, false, false, 53);
                    yield "\" />
                    ";
                }
                // line 54
                ...
                // line 56
                yield CoreExtension::getAttribute($this->env, $this->source, $context["layout"], "edit", [], "any", false, false, false, 56);
                yield "\" data-toggle=\"tooltip\" title=\"";
