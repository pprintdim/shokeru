...
class __TwigTemplate_7c4b19864cc2edc1c932a23e51137f20 extends Template
{
...
\t                    </button>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                ...
                // line 337
                yield "                            ";
                yield from $this->load("product/product_card.twig", 337)->unwrap()->yield(CoreExtension::merge($context, ["product" => ($context["product"] ?? null)]));
                // line 338
                yield "                        ";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
