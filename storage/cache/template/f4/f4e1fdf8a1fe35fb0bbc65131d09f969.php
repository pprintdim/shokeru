...
class __TwigTemplate_af629706331ba8cbfb47aa948ea94756 extends Template
{
...
\t\t\t      ";
    ...
    \t\t\t\t                \t<img src=\"";
                // line 27
                yield CoreExtension::getAttribute($this->env, $this->source, $context["image"], "popup", [], "any", false, false, false, 27);
                yield "\" alt=\"";
                yield ($context["name"] ?? null);
                yield "\">
    \t\t\t\t                </div>
                ...
                yield "
                                ...
                                <div class=\"product__item-info\">
                                    <a class=\"product__item-title\" href=\"#\">
                                        <h3>";
                // line 174
                yield CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "name", [], "any", false, false, false, 174);
                yield "</h3>
                                    </a>
                                    <p class=\"product__item-price\">
                                        ";
                // line 177
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "special", [], "any", false, false, false, 177)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 178
                    yield "                                            <span>";
                    yield CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "price", [], "any", false, false, false, 178);
                    yield "</span>
                                        ";
                }
                // line 180
                yield "                                        ";
                yield ((CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "special", [], "any", false, false, false, 180)) ? (CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "special", [], "any", false, false, false, 180)) : (CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "price", [], "any", false, false, false, 180)));
                yield "
                                    </p>
                                </div>
                            </div>
...
const thumbsSwiper = new Swiper('.prod__thumbs', {
    ...
    simulateTouch: true,
    grabCursor: true,
    mousewheel: true, // дозволяє скрол на трекпаді
});
...
";
    ...
    {
        return array (  506 => 263,  434 => 193,  425 => 186,  412 => 180,  406 => 178,  404 => 177,  398 => 174,  385 => 164,  375 => 159,  371 => 158,  367 => 156,  364 => 155,  359 => 154,  357 => 153,  352 => 152,  350 => 151,  330 => 133,  328 => 132,  308 => 114,  300 => 111,  289 => 109,  285 => 108,  280 => 106,  276 => 104,  272 => 103,  263 => 97,  258 => 95,  245 => 85,  230 => 74,  224 => 72,  222 => 71,  207 => 61,  203 => 60,  191 => 50,  188 => 49,  177 => 46,  174 => 45,  169 => 44,  167 => 43,  164 => 42,  156 => 39,  153 => 38,  151 => 37,  143 => 31,  140 => 30,  129 => 27,  126 => 26,  121 => 25,  119 => 24,  116 => 23,  108 => 20,  105 => 19,  103 => 18,  96 => 13,  78 => 9,  70 => 8,  67 => 7,  50 => 6,  42 => 1,);
    }
