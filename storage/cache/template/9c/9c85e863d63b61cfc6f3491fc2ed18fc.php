...
class __TwigTemplate_f01c35eb54b8e319357dba232cd6f256 extends Template
{
    ...
    <form class=\"shop__filters\" action=\"";
        ...
        yield "            </div>
            ...
            ";
        // line 21
        yield "            <select class=\"shop__filters-sort\" name=\"sort\" onchange=\"if(this.value) window.location.href=this.value;\">
                ";
        // line 22
        $context['_parent'] = $context;
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
            ...
            yield CoreExtension::getAttribute($this->env, $this->source, $context["group"], "filter_group_id", [], "any", false, false, false, 33);
            yield "\">
                            <div class=\"shop__filters-block\">
                                <h3 class=\"shop__filters-title\">";
            // line 35
            yield CoreExtension::getAttribute($this->env, $this->source, $context["group"], "name", [], "any", false, false, false, 35);
            yield "</h3>
                                <div class=\"shop__filters-select\">
                                    ";
            // line 37
            $context['_parent'] = $context;
            $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, $context["group"], "filter", [], "any", false, false, false, 37));
            foreach ($context['_seq'] as $context["_key"] => $context["filter"]) {
                // line 38
                yield "                                        <label class=\"checkbox-block\">
                                            <input type=\"checkbox\" name=\"filter[]\" value=\"";
                // line 39
                yield CoreExtension::getAttribute($this->env, $this->source, $context["filter"], "filter_id", [], "any", false, false, false, 39);
                yield "\" hidden
                                                ";
                // line 40
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["filter"], "selected", [], "any", false, false, false, 40)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    yield "checked";
                }
                yield ">
                                            <span>";
                // line 41
                yield CoreExtension::getAttribute($this->env, $this->source, $context["filter"], "name", [], "any", false, false, false, 41);
                yield "</span>
                                        </label>
                                    ";
            }
...
";
    ...
    {
        return array (  205 => 68,  196 => 61,  192 => 60,  186 => 56,  183 => 54,  168 => 44,  159 => 41,  153 => 40,  149 => 39,  146 => 38,  142 => 37,  137 => 35,  131 => 33,  126 => 32,  118 => 25,  103 => 23,  99 => 22,  96 => 21,  92 => 18,  86 => 17,  80 => 16,  74 => 13,  70 => 12,  67 => 11,  64 => 10,  59 => 9,  55 => 8,  52 => 7,  45 => 2,  42 => 1,);
    }
