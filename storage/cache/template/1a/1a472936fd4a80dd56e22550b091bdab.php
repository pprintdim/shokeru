...
class __TwigTemplate_25f1646a63db79d858d21674745b08e3 extends Template
{
  ...
  <div class=\"page-header\">
    <div class=\"container-fluid\">
      <div class=\"pull-right\"><a href=\"";
        ...
        yield "') ? \$('#form-download').submit() : false;\"><i class=\"fa fa-trash-o\"></i></button>
      </div>
      <h1>";
        // line 8
  ...
  <div class=\"container-fluid\">
    ...
    ";
      ...
      <div class=\"panel-body\">
        ...
        yield "\" method=\"post\" enctype=\"multipart/form-data\" id=\"form-download\">
        ...
        if ((($tmp = ($context["downloads"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["download"]) {
                ...
                // line 55
                if (CoreExtension::inFilter(CoreExtension::getAttribute($this->env, $this->source, $context["download"], "download_id", [], "any", false, false, false, 55), ($context["selected"] ?? null))) {
                    // line 56
                    yield "                    <input type=\"checkbox\" name=\"selected[]\" value=\"";
                    yield CoreExtension::getAttribute($this->env, $this->source, $context["download"], "download_id", [], "any", false, false, false, 56);
                    yield "\" checked=\"checked\" />
                    ";
                } else {
                    // line 58
                    yield "                    <input type=\"checkbox\" name=\"selected[]\" value=\"";
                    yield CoreExtension::getAttribute($this->env, $this->source, $context["download"], "download_id", [], "any", false, false, false, 58);
                    yield "\" />
                    ";
                }
                // line 59
                yield "</td>
                  <td class=\"text-left\">";
                // line 60
                yield CoreExtension::getAttribute($this->env, $this->source, $context["download"], "name", [], "any", false, false, false, 60);
                yield "</td>
                  <td class=\"text-right\">";
                // line 61
                yield CoreExtension::getAttribute($this->env, $this->source, $context["download"], "date_added", [], "any", false, false, false, 61);
                yield "</td>
                  <td class=\"text-right\"><a href=\"";
                // line 62
                yield CoreExtension::getAttribute($this->env, $this->source, $context["download"], "edit", [], "any", false, false, false, 62);
                yield "\" data-toggle=\"tooltip\" title=\"";
