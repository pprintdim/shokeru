...
class __TwigTemplate_9ee88d91765a949f59ac24a25d07ab03 extends Template
{
    ...
    <form class=\"shop__filters\" action=\"";
        ...
        yield "            </div>
            ...
            ";
        // line 21
        yield "           <select class=\"shop__filters-sort\" name=\"sort\">
                ";
        // line 22
        $context['_parent'] = $context;
        ...
        foreach ($context['_seq'] as $context["value"] => $context["text"]) {
            ...
            // line 24
            yield "                    <option value=\"";
            yield (($_v0 = ($context["sort_links"] ?? null)) && is_array($_v0) || $_v0 instanceof ArrayAccess ? ($_v0[$context["value"]] ?? null) : null);
            yield "\" ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
            ...
            yield CoreExtension::getAttribute($this->env, $this->source, $context["group"], "filter_group_id", [], "any", false, false, false, 38);
            yield "\">
                            <div class=\"shop__filters-block\">
                                <h3 class=\"shop__filters-title\">";
            // line 40
            yield CoreExtension::getAttribute($this->env, $this->source, $context["group"], "name", [], "any", false, false, false, 40);
            yield "</h3>
                                <div class=\"shop__filters-select\">
                                    ";
            // line 42
            $context['_parent'] = $context;
            $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, $context["group"], "filter", [], "any", false, false, false, 42));
            foreach ($context['_seq'] as $context["_key"] => $context["filter"]) {
                // line 43
                yield "                                        <label class=\"checkbox-block\">
                                            <input type=\"checkbox\" name=\"filter[]\" value=\"";
                // line 44
                yield CoreExtension::getAttribute($this->env, $this->source, $context["filter"], "filter_id", [], "any", false, false, false, 44);
                yield "\" hidden
                                                ";
                // line 45
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["filter"], "selected", [], "any", false, false, false, 45)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    yield "checked";
                }
                yield ">
                                            <span>";
                // line 46
                yield CoreExtension::getAttribute($this->env, $this->source, $context["filter"], "name", [], "any", false, false, false, 46);
                yield "</span>
                                        </label>
                                    ";
            }
    ...
    <script>
        ...
        document.addEventListener(\"DOMContentLoaded\", function () {
            ...
            document.querySelector('.shop__filters-sort').addEventListener('change', function() {
...
";
    ...
    {
        return array (  212 => 73,  203 => 66,  199 => 65,  193 => 61,  190 => 59,  175 => 49,  166 => 46,  160 => 45,  156 => 44,  153 => 43,  149 => 42,  144 => 40,  138 => 38,  133 => 37,  121 => 26,  106 => 24,  103 => 23,  99 => 22,  96 => 21,  92 => 18,  86 => 17,  80 => 16,  74 => 13,  70 => 12,  67 => 11,  64 => 10,  59 => 9,  55 => 8,  52 => 7,  45 => 2,  42 => 1,);
    }
