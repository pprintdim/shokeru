...
class __TwigTemplate_51cc2a894d2ecb1e78e107fadeb63adf extends Template
{
...
\t                                <h3 class=\"prod__item-title\">";
            // line 104
            yield CoreExtension::getAttribute($this->env, $this->source, $context["group"], "name", [], "any", false, false, false, 104);
            yield "</h3>
\t                                <div class=\"prod__item-content prod__item-info\">
\t                                \t";
            // line 106
            $context['_parent'] = $context;
            $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, $context["group"], "attribute", [], "any", false, false, false, 106));
            foreach ($context['_seq'] as $context["_key"] => $context["attribute"]) {
                // line 107
                yield "\t                                    \t<p>";
                yield CoreExtension::getAttribute($this->env, $this->source, $context["attribute"], "name", [], "any", false, false, false, 107);
                yield ": <strong>";
                yield CoreExtension::getAttribute($this->env, $this->source, $context["attribute"], "text", [], "any", false, false, false, 107);
                yield "</strong></p>
\t                                    ";
            }
            $_parent = $context['_parent'];
    ...
    <div class=\"container\">
        <div class=\"productSlider__inner\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                ...
                yield "\" alt=\"";
                yield CoreExtension::getAttribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 153);
                yield "\">
                            </a>
                            <div class=\"product__item-content\">
                                ...
                                <div class=\"product__item-info\">
                                    <a class=\"product__item-title\" href=\"#\">
                                        <h3>";
                // line 168
                yield CoreExtension::getAttribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 168);
                yield "</h3>
                                    </a>
                                    <p class=\"product__item-price\">
                                        ";
                // line 171
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 171)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 172
                    yield "                                            <span>";
                ...
                // line 174
                yield "                                        ";
                yield ((CoreExtension::getAttribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 174)) ? (CoreExtension::getAttribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 174)) : (CoreExtension::getAttribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 174)));
                yield "
                                    </p>
                                </div>
                            </div>
...
";
    ...
    {
        return array (  430 => 202,  413 => 187,  404 => 180,  391 => 174,  385 => 172,  383 => 171,  377 => 168,  357 => 153,  353 => 152,  349 => 150,  345 => 149,  325 => 131,  323 => 130,  303 => 112,  295 => 109,  284 => 107,  280 => 106,  275 => 104,  271 => 102,  267 => 101,  258 => 95,  253 => 93,  228 => 72,  222 => 70,  220 => 69,  205 => 59,  201 => 58,  189 => 48,  186 => 47,  175 => 44,  172 => 43,  167 => 42,  165 => 41,  162 => 40,  154 => 37,  151 => 36,  149 => 35,  142 => 30,  139 => 29,  128 => 26,  125 => 25,  120 => 24,  118 => 23,  115 => 22,  107 => 19,  104 => 18,  102 => 17,  96 => 13,  78 => 9,  70 => 8,  67 => 7,  50 => 6,  42 => 1,);
    }
