...
class __TwigTemplate_6c4c5644d34aedb657453aeec2edc500 extends Template
{
    ...
    <div class=\"container\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["phone"]) {
            ...
            yield CoreExtension::getAttribute($this->env, $this->source, $context["phone"], "href", [], "any", false, false, false, 25);
            yield "\">";
            yield CoreExtension::getAttribute($this->env, $this->source, $context["phone"], "label", [], "any", false, false, false, 25);
            yield "</a>
                                          ";
            // line 26
                                ...
                                <form id=\"popup-login-form\" class=\"userPopup__form\">
                                    <div class=\"userPopup__form-block\">
                                        ...
                                        <div class=\"userPopup__form-item\">
                                            ...
                                            <input class=\"userPopup__form-input\" type=\"password\" name=\"password\" placeholder=\"";
        // line 69
        yield ($context["text_password"] ?? null);
        yield "*\" required>
                                        </div>
                                    </div>
                                    <button class=\"userPopup__form-forgot\" type=\"button\">";
        // line 72
        yield ($context["text_forgot"] ?? null);
        yield "</button>
                                    <label class=\"userPopup__form-checkbox checkbox-block\">
                                        <input type=\"checkbox\" name=\"checked\" class=\"visually-hidden\" required>
                                        <span>";
        // line 75
                                ...
                                <script>
                                    document.addEventListener('DOMContentLoaded', function() {
                                        ...
                                        form.addEventListener('submit', function(e) {
                                            ...
                                            const agree = form.querySelector('input[name=\"checked\"]').checked;

                                            const data = new FormData();
                                            data.append('email', email);
                                            data.append('password', password);
                                            data.append('agree', agree ? 1 : 0); // передаємо в контролер
                                            ...
                                            .then(json => {
                                                if (json.success) {
                                                    ...
                                                    // Всі помилки, включно з відсутністю згоди
                                                    if (typeof json.error === 'object') {
                                                        // Якщо помилки по полях
                                                        let messages = [];
        ...
        // line 144
        yield ($context["text_telefone"] ?? null);
        yield "\" required>
                                        </div>
                                        <div class=\"userPopup__form-item\">
                                            <input class=\"userPopup__form-input\" type=\"email\" name=\"email\" placeholder=\"Email\" required>
        ...
        yield "</p>
                                    <div class=\"userPopup__form-block\">
                                        <div class=\"userPopup__form-item\">
                                            <button class=\"userPopup__form-show form-show-password\" type=\"button\"></button>
                                            <input class=\"userPopup__form-input\" type=\"password\" name=\"Пароль\" placeholder=\"Пароль*\" required>
                                        </div>
                                        <div class=\"userPopup__form-item\">
                                            <button class=\"userPopup__form-show form-show-password\" type=\"button\"></button>
                                            <input class=\"userPopup__form-input\" type=\"password\" name=\"Повторите-пароль\" placeholder=\"Повторите пароль*\" required>
                                        </div>
                                    </div>
                                    <label class=\"userPopup__form-checkbox checkbox-block\">
                                        <input type=\"checkbox\" name=\"checked\" class=\"visually-hidden\" required>
                                ...
                                <script>
                                    document.addEventListener('DOMContentLoaded', function() {
                                        ...
                                        form.addEventListener('submit', function(e) {
                                            ...
                                            fetch('index.php?route=extension/module/user_popup/register', {
                                                method: 'POST',
                                                body: formData
                                            })
                                            .then(response => response.json())
...
<section class=\"userData\" data-userData=\"password-recovery\">
    <div class=\"container\">
        ...
        yield "
                <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"40\" height=\"40\" viewBox=\"0 0 40 40\" fill=\"none\">
                    ...
                    <form id=\"popup-forgotten-form\" class=\"userData__form form-block\" action=\"#\">
    ...
    {
        return array (  406 => 257,  399 => 253,  372 => 229,  309 => 169,  305 => 168,  299 => 165,  294 => 163,  278 => 150,  269 => 144,  263 => 141,  257 => 138,  197 => 81,  193 => 80,  187 => 77,  182 => 75,  176 => 72,  170 => 69,  157 => 59,  153 => 58,  131 => 39,  120 => 30,  106 => 29,  102 => 27,  100 => 26,  93 => 25,  76 => 24,  60 => 11,  55 => 9,  51 => 8,  42 => 1,);
    }
