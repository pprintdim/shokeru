...
class __TwigTemplate_3a2d1bfbee160679e8914b26d4d64e8d extends Template
{
...
\t                    \t";
    ...
    \t       \t                        </div>
                                        <div class=\"product__item-info\">
                                            <a class=\"product__item-title\" href=\"";
                // line 122
                yield CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "href", [], "any", false, false, false, 122);
                yield "\">
                                                <h3>";
                // line 123
                yield CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "name", [], "any", false, false, false, 123);
                yield "</h3>
                                            </a>
                                            <p class=\"product__item-price\">
                                                ";
                // line 126
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "special", [], "any", false, false, false, 126)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 127
                    yield "                                                    <span>";
                    yield CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "price", [], "any", false, false, false, 127);
                    yield "</span>
                                                    ";
                    // line 128
                    yield CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "special", [], "any", false, false, false, 128);
                    yield "
                                                ";
                } else {
                    // line 130
...
";
    ...
    {
        return array (  297 => 145,  293 => 143,  285 => 137,  275 => 132,  269 => 130,  264 => 128,  259 => 127,  257 => 126,  251 => 123,  247 => 122,  233 => 111,  224 => 107,  220 => 106,  216 => 104,  213 => 103,  209 => 102,  194 => 90,  187 => 85,  184 => 84,  181 => 83,  178 => 82,  176 => 81,  169 => 77,  147 => 57,  143 => 55,  130 => 49,  124 => 47,  122 => 46,  116 => 43,  98 => 28,  91 => 24,  85 => 20,  82 => 19,  78 => 18,  74 => 16,  72 => 15,  67 => 14,  64 => 13,  62 => 12,  57 => 10,  47 => 3,  42 => 1,);
    }
