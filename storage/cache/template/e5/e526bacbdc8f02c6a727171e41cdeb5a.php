...
class __TwigTemplate_68d7a21373d6a075bb78ebd725bc5a43 extends Template
{
...
\t";
    ...
    <section class=\"shop\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["sort"]) {
            // line 26
            yield "                                        <option value=\"";
            yield CoreExtension::getAttribute($this->env, $this->source, $context["sort"], "value", [], "any", false, false, false, 26);
            yield "\" ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["sort"]) {
            // line 45
            yield "                                                <option value=\"";
            yield CoreExtension::getAttribute($this->env, $this->source, $context["sort"], "value", [], "any", false, false, false, 45);
            yield "\" ";
