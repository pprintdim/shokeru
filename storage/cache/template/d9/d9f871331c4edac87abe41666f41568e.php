...
class __TwigTemplate_b93985ce84d13114be822384e46e6a9a extends Template
{
    ...
    <div class=\"panel panel-default\">
      ...
      <div class=\"panel-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["language"]) {
            ...
            yield "][title]\" value=\"";
            yield (((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["benefits_content"] ?? null), CoreExtension::getAttribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 76), [], "array", false, true, false, 76), "title", [], "any", true, true, false, 76) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, (($_v0 = ($context["benefits_content"] ?? null)) && is_array($_v0) || $_v0 instanceof ArrayAccess ? ($_v0[CoreExtension::getAttribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 76)] ?? null) : null), "title", [], "any", false, false, false, 76)))) ? (CoreExtension::getAttribute($this->env, $this->source, (($_v1 = ($context["benefits_content"] ?? null)) && is_array($_v1) || $_v1 instanceof ArrayAccess ? ($_v1[CoreExtension::getAttribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 76)] ?? null) : null), "title", [], "any", false, false, false, 76)) : (""));
            yield "\" class=\"form-control\">
                    </div>
                </div>
                <div class=\"form-group\">
            ...
            yield (((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["benefits_content"] ?? null), CoreExtension::getAttribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 82), [], "array", false, true, false, 82), "description", [], "any", true, true, false, 82) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, (($_v2 = ($context["benefits_content"] ?? null)) && is_array($_v2) || $_v2 instanceof ArrayAccess ? ($_v2[CoreExtension::getAttribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 82)] ?? null) : null), "description", [], "any", false, false, false, 82)))) ? (CoreExtension::getAttribute($this->env, $this->source, (($_v3 = ($context["benefits_content"] ?? null)) && is_array($_v3) || $_v3 instanceof ArrayAccess ? ($_v3[CoreExtension::getAttribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 82)] ?? null) : null), "description", [], "any", false, false, false, 82)) : (""));
            yield "</textarea>
                    </div>
                </div>
            ...
            yield "</th>
                ...
                ";
            // line 95
            if ((($tmp = (($_v4 = ($context["benefits"] ?? null)) && is_array($_v4) || $_v4 instanceof ArrayAccess ? ($_v4[CoreExtension::getAttribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 95)] ?? null) : null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 96
                yield "                    ";
                $context['_parent'] = $context;
                $context['_seq'] = CoreExtension::ensureTraversable((($_v5 = ($context["benefits"] ?? null)) && is_array($_v5) || $_v5 instanceof ArrayAccess ? ($_v5[CoreExtension::getAttribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 96)] ?? null) : null));
...
";
    ...
    {
        return array (  373 => 163,  348 => 141,  337 => 132,  322 => 123,  318 => 122,  312 => 118,  309 => 117,  303 => 116,  301 => 115,  293 => 110,  286 => 106,  280 => 105,  273 => 101,  267 => 100,  260 => 97,  255 => 96,  253 => 95,  245 => 90,  241 => 89,  237 => 88,  231 => 85,  221 => 82,  216 => 80,  207 => 76,  202 => 74,  196 => 72,  191 => 71,  189 => 70,  184 => 67,  174 => 63,  168 => 62,  164 => 61,  161 => 60,  157 => 59,  145 => 52,  139 => 51,  133 => 48,  124 => 42,  119 => 40,  112 => 36,  105 => 32,  100 => 29,  94 => 26,  91 => 25,  89 => 24,  82 => 19,  71 => 17,  67 => 16,  62 => 14,  55 => 10,  42 => 1,);
    }
