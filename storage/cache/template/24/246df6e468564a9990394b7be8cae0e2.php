...
class __TwigTemplate_393627a55b67409ad9ad77438970239a extends Template
{
            ...
            if ((($tmp = (($_v4 = ($context["repeater"] ?? null)) && is_array($_v4) || $_v4 instanceof ArrayAccess ? ($_v4[CoreExtension::getAttribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 92)] ?? null) : null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    ...
                    yield "</textarea>
                            ...
                            <button type=\"button\" class=\"btn btn-danger mb-2\" onclick=\"\$('#row";
                    // line 103
                    yield ($context["row"] ?? null);
                    yield "').remove()\">
...
function addRow(lang) {
    ...
    <div class=\"repeater-item border rounded p-3 mb-3\" id=\"row\${row}\">
      ...
      <button type=\"button\" class=\"btn btn-danger mb-2\" onclick=\"\$('#row\${row}').remove()\">
        <i class=\"fa fa-minus-circle\"></i> ";
        // line 147
        yield ($context["button_remove"] ?? null);
        yield "
...
window.addRow = addRow; // доступність глобально
...
";
    ...
    {
        return array (  383 => 160,  367 => 147,  360 => 143,  353 => 139,  345 => 134,  326 => 117,  314 => 111,  309 => 110,  306 => 109,  300 => 108,  298 => 107,  292 => 104,  288 => 103,  279 => 101,  275 => 100,  265 => 97,  261 => 96,  255 => 94,  250 => 93,  247 => 92,  245 => 91,  241 => 90,  232 => 86,  227 => 84,  218 => 80,  213 => 78,  207 => 76,  205 => 75,  202 => 74,  197 => 73,  195 => 72,  190 => 69,  174 => 65,  170 => 64,  167 => 63,  163 => 62,  151 => 55,  145 => 54,  139 => 51,  130 => 45,  125 => 43,  119 => 40,  112 => 36,  105 => 32,  100 => 29,  94 => 26,  91 => 25,  89 => 24,  82 => 19,  71 => 17,  67 => 16,  62 => 14,  55 => 10,  42 => 1,);
    }
