...
class __TwigTemplate_5e3de32d6c048fef54c1a9a1cb2d7de5 extends Template
{
...
\t                    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                ...
                // line 277
                yield "\t\t                        ";
                yield from $this->load("shokeru/product/product_card.twig", 277)->unwrap()->yield(CoreExtension::merge($context, ["product" => ($context["product"] ?? null)]));
                // line 278
                yield "\t                    \t";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
...
\t                    </button>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                ...
                // line 337
                yield "                            ";
                yield from $this->load("shokeru/product/product_card.twig", 337)->unwrap()->yield(CoreExtension::merge($context, ["product" => ($context["product"] ?? null)]));
                // line 338
                yield "                        ";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
...
";
    ...
    {
        return array (  309 => 404,  248 => 345,  240 => 339,  226 => 338,  223 => 337,  220 => 336,  203 => 335,  188 => 323,  181 => 318,  178 => 317,  175 => 316,  172 => 315,  170 => 314,  135 => 281,  131 => 279,  117 => 278,  114 => 277,  111 => 276,  94 => 275,  90 => 273,  88 => 272,  83 => 271,  80 => 270,  78 => 269,  75 => 268,  67 => 20,  47 => 3,  42 => 1,);
    }
