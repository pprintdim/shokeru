...
class __TwigTemplate_1798b395487bda07d220f33d5bbc9d62 extends Template
{
      ...
      <div class=\"panel-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["language"]) {
            ...
            yield "\">
                ...
                ";
            // line 93
            if ((($tmp = (($_v4 = ($context["repeater"] ?? null)) && is_array($_v4) || $_v4 instanceof ArrayAccess ? ($_v4[CoreExtension::getAttribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 93)] ?? null) : null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 94
                yield "                    ";
                $context['_parent'] = $context;
                $context['_seq'] = CoreExtension::ensureTraversable((($_v5 = ($context["repeater"] ?? null)) && is_array($_v5) || $_v5 instanceof ArrayAccess ? ($_v5[CoreExtension::getAttribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 94)] ?? null) : null));
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    ...
                    yield CoreExtension::getAttribute($this->env, $this->source, $context["item"], "description", [], "any", false, false, false, 98);
                    yield "</textarea>
                      </td>
...
function addRow(lang) {
    const html = `
      <tr id=\"row\${row}\">
        <td>
        <input type=\"text\" name=\"repeater[\${lang}][\${row}][title]\" class=\"form-control\">
        <textarea name=\"repeater[\${lang}][\${row}][description]\" class=\"form-control\"></textarea>
        </td>
        <td class=\"text-center\">
