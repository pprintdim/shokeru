...
class __TwigTemplate_adec439f205c27121bac7e2729d10a87 extends Template
{
    ...
    <div class=\"panel panel-default\">
      ...
      <div class=\"panel-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["language"]) {
            ...
            // line 92
            yield "                ";
            if ((($tmp = (($_v4 = ($context["repeater"] ?? null)) && is_array($_v4) || $_v4 instanceof ArrayAccess ? ($_v4[CoreExtension::getAttribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 92)] ?? null) : null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 93
                yield "                    ";
                $context['_parent'] = $context;
                $context['_seq'] = CoreExtension::ensureTraversable((($_v5 = ($context["repeater"] ?? null)) && is_array($_v5) || $_v5 instanceof ArrayAccess ? ($_v5[CoreExtension::getAttribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 93)] ?? null) : null));
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 94
                    yield "                    <div class=\"repeater-item\" id=\"row";
                    ...
                    yield ($context["row"] ?? null);
                    yield "][title]\" value=\"";
                    yield CoreExtension::getAttribute($this->env, $this->source, $context["item"], "title", [], "any", false, false, false, 97);
                    yield "\" class=\"form-control\">
                        </div>
                        <div class=\"form-group\">
                        <label>";
                    ...
                    yield CoreExtension::getAttribute($this->env, $this->source, $context["item"], "description", [], "any", false, false, false, 101);
                    yield "</textarea>
                        </div>
...
function addRow(lang) {
    const html = `
    <div class=\"repeater-item\" id=\"row\${row}\">
      <div class=\"form-group\">
        <label>";
        // line 140
        yield ($context["entry_title"] ?? null);
    ...
    \$(`#row\${row} .summernote`).summernote({
        height: 160,
        callbacks: {
            onImageUpload: function(files) {
                // Можна додати свій обробник завантаження зображень
            }
        }
    });
...
";
    ...
    {
        return array (  396 => 172,  369 => 148,  362 => 144,  355 => 140,  346 => 134,  328 => 118,  316 => 112,  312 => 111,  309 => 110,  306 => 109,  300 => 108,  298 => 107,  292 => 104,  288 => 103,  279 => 101,  275 => 100,  265 => 97,  261 => 96,  255 => 94,  250 => 93,  247 => 92,  245 => 91,  241 => 90,  232 => 86,  227 => 84,  218 => 80,  213 => 78,  207 => 76,  205 => 75,  202 => 74,  197 => 73,  195 => 72,  190 => 69,  174 => 65,  170 => 64,  167 => 63,  163 => 62,  151 => 55,  145 => 54,  139 => 51,  130 => 45,  125 => 43,  119 => 40,  112 => 36,  105 => 32,  100 => 29,  94 => 26,  91 => 25,  89 => 24,  82 => 19,  71 => 17,  67 => 16,  62 => 14,  55 => 10,  42 => 1,);
    }
