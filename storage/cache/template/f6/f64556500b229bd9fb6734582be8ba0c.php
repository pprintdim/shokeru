...
class __TwigTemplate_16851e39d4e1ae390f4b0b34e1367acd extends Template
{
...
\t                    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                ...
                // line 277
                yield "\t\t                        ";
                yield from $this->load("product_card.twig", 277)->unwrap()->yield(CoreExtension::merge($context, ["product" => ($context["product"] ?? null)]));
                // line 278
                yield "
\t                    \t";
                ++$context['loop']['index0'];
...
\t                    </button>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                ...
                // line 338
                yield "                            ";
                yield from $this->load("product_card.twig", 338)->unwrap()->yield(CoreExtension::merge($context, ["product" => ($context["product"] ?? null)]));
                // line 339
                yield "
                        ";
                ++$context['loop']['index0'];
