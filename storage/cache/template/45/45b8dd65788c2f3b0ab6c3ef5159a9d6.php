...
class __TwigTemplate_bb81630cd713ecfed2e6e87dad77c68d extends Template
{
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["language"]) {
            ...
            if ((($tmp = (($_v4 = ($context["repeater"] ?? null)) && is_array($_v4) || $_v4 instanceof ArrayAccess ? ($_v4[($context["lang_id"] ?? null)] ?? null) : null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 96
                    yield "                  <div class=\"panel panel-default repeater-item\" id=\"row";
                    ...
                    yield ($context["row"] ?? null);
                    yield "][title]\" value=\"";
                    yield CoreExtension::getAttribute($this->env, $this->source, $context["item"], "title", [], "any", false, false, false, 101);
                    yield "\" class=\"form-control\">
                        </div>
                      </div>
                      <div class=\"form-group\">
...
function addRow(lang) {
    const newRow = `
    <div class=\"panel panel-default repeater-item\" id=\"row\${row}\">
      <div class=\"panel-body\">
        <div class=\"form-group\">
          <label class=\"col-sm-2 control-label\">";
        // line 154
...
";
    ...
    {
        return array (  403 => 181,  387 => 168,  376 => 160,  367 => 154,  358 => 148,  337 => 129,  325 => 123,  320 => 122,  317 => 121,  311 => 120,  309 => 119,  300 => 113,  296 => 112,  284 => 107,  279 => 105,  268 => 101,  263 => 99,  256 => 96,  251 => 95,  248 => 94,  246 => 93,  242 => 92,  232 => 87,  227 => 85,  217 => 80,  212 => 78,  205 => 75,  202 => 74,  197 => 73,  195 => 72,  190 => 69,  174 => 65,  170 => 64,  167 => 63,  163 => 62,  151 => 55,  145 => 54,  139 => 51,  130 => 45,  125 => 43,  119 => 40,  112 => 36,  105 => 32,  100 => 29,  94 => 26,  91 => 25,  89 => 24,  82 => 19,  71 => 17,  67 => 16,  62 => 14,  55 => 10,  42 => 1,);
    }
