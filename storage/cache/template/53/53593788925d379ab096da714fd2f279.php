...
class __TwigTemplate_ce35d99d000fa847bd34012c5a3a49cd extends Template
{
    ...
    <section class=\"productSlider\">
        <div class=\"container\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                ...
                // line 30
                yield CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "href", [], "any", false, false, false, 30);
                yield "\">
                                    <img src=\"";
                // line 31
                yield CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "thumb", [], "any", false, false, false, 31);
                yield "\" alt=\"";
                yield CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "name", [], "any", false, false, false, 31);
                yield "\">
                                </a>
                ...
                // line 35
                yield CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "product_id", [], "any", false, false, false, 35);
                yield "');\">
                                            В корзину
                ...
                // line 41
                yield CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "href", [], "any", false, false, false, 41);
                yield "\">
                                            Подробнее
                ...
                // line 49
                yield CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "href", [], "any", false, false, false, 49);
                yield "\">
                                            <h3>";
                // line 50
                yield CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "name", [], "any", false, false, false, 50);
                yield "</h3>
                                        </a>
                                        <p class=\"product__item-price\">
                                            ";
                // line 53
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "special", [], "any", false, false, false, 53)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 54
                    yield "                                                <span>";
                    yield CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "price", [], "any", false, false, false, 54);
                    yield "</span>
                                            ";
                }
                // line 56
                yield "                                            ";
                yield ((CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "special", [], "any", false, false, false, 56)) ? (CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "special", [], "any", false, false, false, 56)) : (CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "price", [], "any", false, false, false, 56)));
                yield "
                                        </p>
                                    </div>
                                </div>
...
";
    ...
    {
        return array (  158 => 64,  154 => 62,  141 => 56,  135 => 54,  133 => 53,  127 => 50,  123 => 49,  112 => 41,  103 => 35,  94 => 31,  90 => 30,  85 => 27,  82 => 26,  77 => 25,  75 => 24,  56 => 8,  47 => 3,  44 => 2,  42 => 1,);
    }
